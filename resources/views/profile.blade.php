<x-app-layout title="{{ __('titles.profile') }}">
  <form action="{{ route('profile.change_email_and_name') }}" method="post" class="form form_styles profile_form">
    @csrf
    @method('put')
  ...
  <form action="{{ route('profile.change_password') }}" method="post" class="form form_styles profile_form">
    @csrf
    @method('put')
  ...
  <form action="{{ route('profile.destroy') }}" method="post" class="form form_styles profile_form">
    @csrf
    @method('delete')
